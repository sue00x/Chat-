...
def change_tts_inference(if_tts,gpu_number,gpt_path,sovits_path):
...
with gr.Blocks(title="Chat中移小智") as app:
    ...
    with gr.Row():
        if_tts = gr.Checkbox(
            label="是否开启TTS推理WebUI",
            show_label=True
        )
        tts_info = gr.Textbox(
            label="TTS推理WebUI进程输出信息"
        )
        if_tts.change(
            change_tts_inference,
            [if_tts, gpu_number_1C, GPT_dropdown, SoVITS_dropdown],
            [tts_info]
        )
    ...
    # with gr.Tabs():
        ...
        # with gr.TabItem(i18n("1-中移小智语音训练")):
        #     with gr.Row():
        ...
        #     button1abc_close.click(close1abc, [], [info1abc,button1abc_open,button1abc_close])
            ...
            # button1Bb_close.click(close1Bb, [], [info1Bb,button1Bb_open,button1Bb_close])
                ...
                #     if_tts.change(change_tts_inference, [if_tts,gpu_number_1C,GPT_dropdown,SoVITS_dropdown], [tts_info])
